"""
sc_projection.py
    ROLE: Gamma-point supercell states (plane waves, gamma trick) on the supercell FFT grid, and their projection on the
    folded unit-cell Bloch basis |nk>_sc. Used by the M-normalization gate (defects/deltav_pw.check_pure_bloch, R6) and by
    the supercell-vs-Wannier-chain diagnostics (R4/R5: overlaps c_nk, Psi_in, parity). Promoted from the R5 campaign module
    r5_sc_projection.py (graphene/qe/defects/R5_base_vs_M/, 2026-09-25) into src/ by R6, unchanged except this header.
