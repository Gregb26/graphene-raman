"""
r5_deltav_pw.py  (R5, 2026-09-25 ; module de campagne, répertoire de travail, hors dépôt)
    Apply the defect potential dV = V_d - V_p to Gamma-point supercell states given on the supercell plane-wave / FFT grid.
...
from r5_sc_projection import grid_to_real, bloch_state_grid
